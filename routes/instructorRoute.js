...
import {
  ...
  createLessonSchema,
  updateLessonSchema,
  uploadLessonResourceSchema,
  createQuizSchema
} from '../validators/instructorValidator.js';
import authMiddleware, { instructorOnly } from '../middleware/authMiddleware.js';
import { videoUpload,resourceUpload, thumbnailUpload } from '../middleware/uploadMiddleware.js';
...
instructorRoutes.patch('/lessons/:lessonId', authMiddleware, instructorOnly, validate(updateLessonSchema), updateLesson);
